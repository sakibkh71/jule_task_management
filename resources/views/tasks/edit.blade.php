                    ...
                    <div class="row-2 mb-3">
                        <div>
                            ...
                            <select name="job_type" class="form-select @error('job_type') is-invalid @enderror" required>
                                <option value="project"      {{ old('job_type', $task->job_type) == 'project'      ? 'selected' : '' }}>Project</option>
                                <option value="service_work" {{ old('job_type', $task->job_type) == 'service_work' ? 'selected' : '' }}>Service Work</option>
                                <option value="on_call"      {{ old('job_type', $task->job_type) == 'on_call'      ? 'selected' : '' }}>On Call</option>
                                <option value="assignment"   {{ old('job_type', $task->job_type) == 'assignment'   ? 'selected' : '' }}>Assignment</option>
                            </select>
                        ...
                        <div>
                            ...
                            <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                                ...
                                <option value="confirmed"   {{ old('status', $task->status) == 'confirmed'   ? 'selected' : '' }}>Confirmed</option>
                    ...
                    <div class="row-2 mb-3">
                        <div>
                            ...
                            <input type="datetime-local" name="start_time"
                                   ...
                                   value="{{ old('start_time', $task->start_time ? $task->start_time->format('Y-m-d\TH:i') : '') }}">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="end_time"
                                   ...
                                   value="{{ old('end_time', $task->end_time ? $task->end_time->format('Y-m-d\TH:i') : '') }}">
